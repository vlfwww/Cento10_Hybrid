      ...
      <section className={style.about}>
        ...
        <div className={style.aboutWrapper}>
          <div className={style.block}>
            ...
            <p className={style.descr}>Представляем десятки европейских брендов</p>
          </div>
          <div className={style.block}>
            <div className={style.wrapper}>
            ...
            <p  className={style.descr}>На некоторые бренды предоставляем пожизненную гарантию</p>
          </div>
          <div className={style.block}>
            <div className={style.wrapper}>
            ...
            <p  className={style.descr}>Специалисты настроят ваш велосипед наилучшим образом</p>
          </div>
          <div className={style.block}>
            <div className={style.wrapper}>
            ...
            <p  className={style.descr}>Доставляем товар всеми популярными транспортными компаниями</p>
          </div>
        </div>
      </section>
            ...
            <div className={style.wrapper}>
                <div className={style.left}>
                  <div className={style.block}>
                    ...
                    <p className={style.descr}>It is a long established fact that a reader will be distracted by the readable content of</p>
                  </div>
                  <div className={style.block}>
                    <div className={style.flex}>
                    ...
                    <p className={style.descr}>The point of using lorem ipsum is that it has a more-or-less normal distribution of letters</p>
                  </div>
                  <div className={style.block}>
                    <div className={style.flex}>
                      <p>Трансмиссия</p>
                    ...
                    <p className={style.descr}>Many desktop publishing packages and web page editors now use lorem ipsum as </p>
                  </div>
                  <div className={style.block}>
                    <div className={style.flex}>
                      <p>Оборудование</p>
                    ...
                    <p className={style.descr}>Contrary to popular belief, lorem ipsum is not simply random text. It has roots in</p>
                  </div>
                </div>
                <div className={style.right}>
